// Add this to scheduleData in Daily Schedule.html for October 15, 2025
...
'2025-10-15': {
    ...
    lab: [
        // DAY SHIFT
        {
            ...
            nickname: 'Dat',
            dept: 'MLS',
            assignment: 'MOB/Split - Pure 1 QC @7:30am [DAILY], Kits QC [DAILY], Sysmex Startup/QC [DAILY], Hematek Startup/QC [DAILY], Previ Gram Stain [DAILY], Novus [WEEKLY-Wed MOB], Stago Maint, Beads Maint, Wipe Benches, Clean Microscopes, Log QC (Evening: Stago [WEEKLY-Wed Both])',
        ...
        },
        {
            ...
            nickname: 'Francis',
            dept: 'MLS',
            assignment: 'AUC Back - Hematology, Chemistry, Molecular, MedTox QC [DAILY], MedTox [MONTHLY-3rd Wed], Hematek [MONTHLY-CATCH UP], Sysmex Startup/QC [DAILY], Hematek Startup/QC [DAILY], Stago Maint, Wipe Benches, Clean Microscopes, Log QC',
            shift: '7:30a-4:00p',
        ...
        },
        {
            ...
            nickname: 'Lorraine',
            dept: 'MLA',
            assignment: 'MOB Support - Assist with QC/Maint, Inventory, SQA Daily [DAILY], Hematek Daily QC [DAILY], Previ Gram [DAILY], Novus [WEEKLY-Wed MOB] (MLA can assist), Urines, Kits ONLY (MLA Restriction), Wipe Benches, Clean Microscopes',
            shift: '8:00a-4:30p',
        ...
        },
        {
            ...
            nickname: 'Steeven',
            dept: 'MLT',
            assignment: 'AUC Front - Processing/Urines, Kits QC [DAILY], Hematek [MONTHLY-CATCH UP], Stago Maint, Wipe Benches, Clean Microscopes, Log QC',
            shift: '8:00a-4:30p',
        ...
        // EVENING SHIFT
        {
            ...
            nickname: 'Tracy',
            dept: 'MLT',
            assignment: 'AUC Evening - Urines, Kits, Stago, ESR 10% Check QC [DAILY], Stago Maint, Stago [WEEKLY-Wed Both], Wipe Benches, Clean Microscopes, Log QC',
            shift: '3:30p-12:00a',
        ...
        },
        {
            ...
            nickname: 'Albert',
            dept: 'MLS',
            assignment: 'AUC Evening - Hematology, Chemistry, Molecular QC, Stago [WEEKLY-Wed Both], Wipe Benches, Clean Microscopes, Log QC',
            shift: '3:30p-12:00a',
        ...
        },
        {
            ...
            nickname: 'Samuel',
            dept: 'MLS',
            assignment: 'AUC Evening - Processing, Stago [WEEKLY-Wed Both], Wipe Benches, Clean Microscopes, Log QC',
            shift: '3:30p-12:00a',
        ...
        // NIGHT SHIFT
        {
            ...
            nickname: 'Boyet',
            dept: 'MLT',
            assignment: 'AUC Night Coverage - MiniSed QC [DAILY], GeneXpert QC [DAILY], GeneXpert [MONTHLY-CATCH UP], Wipe Benches, Clean Microscopes, Log QC',
            shift: '9:30p-6:00a',
        ...
        },
        {
            ...
            nickname: 'George',
            dept: 'MLS',
            assignment: 'AUC Night Coverage - Pure 2 QC @3am [DAILY], MiniSed QC [DAILY], GeneXpert QC [DAILY], GeneXpert [MONTHLY-CATCH UP], Wipe Benches, Clean Microscopes, Log QC',
            shift: '11:30p-8:00a',
